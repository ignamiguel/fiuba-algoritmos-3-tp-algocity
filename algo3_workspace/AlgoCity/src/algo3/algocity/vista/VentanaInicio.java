...
public class VentanaInicio extends JFrame {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaInicio frame = new VentanaInicio(juego);
	...
	public VentanaInicio(final Juego juego) {
		...
		//setIconImage(new ImageIcon(getClass().getResource("algo3.algocity.vista\\logo.gif")).getImage());
		...
		((JPanel)getContentPane()).setOpaque(false);
		  //ImageIcon uno=new ImageIcon(this.getClass().getResource("Imagenes\\algocity.jpg"));
